...
const contractABI = require("../artifacts/contracts/Tokenprompt.sol/Tokenprompt.json").abi;

program
    .name("tokenprompt-cli")
    .description("CLI tool for Tokenprompt smart contract")
    .version("1.0.0");
